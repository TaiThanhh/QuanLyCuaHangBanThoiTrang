		...
		<div class="banner">
			<div class="container">
				...
				<?php foreach ($data_cate as $cate) : ?>
					<div class="col-md-6">
						<div class="banner_item align-items-center" style="background-image:url(../image/banner_cate.jpg)">
							<div class="banner_category">
								<a href="products_one_category.php?id=<?= $cate->Id ?>"><?= $cate->Categry_Name ?></a>
							</div>
						</div>
					</div>
				<?php endforeach; ?>
