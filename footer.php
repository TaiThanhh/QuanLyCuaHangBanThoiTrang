				...
				<div class="row">
					<div class="col-lg-12">
						<div class="footer_nav_container">
							<div class="cr">Đồ Án Phát Triển Phần Mềm <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">Nguyễn Thành Tài </a> &amp;  <a href="https://themewagon.com">Văn Hữu Dũng</a></div>
						</div>
					</div>
				</div>
			</div>
