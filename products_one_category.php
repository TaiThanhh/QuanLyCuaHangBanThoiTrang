...
$db = new Database();
$pdo = $db->getConnect();
$cate = Category::getCategory_ById($pdo,$id);
$data = Product::getProduct_Category($pdo,$id);
$data_bestseller = Product::getAll($pdo);
$title = $cate->Categry_Name;
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="col">
				<div class="product_slider_container">
					<div class="owl-carousel owl-theme product_slider">
						...
						<?php foreach ($data_bestseller as $pro) : ?>
